...
public class Interaktionsbrett {
   ...
   * 
   * @param text
   *          Text dessen Ausgabel&auml;nge in Pixel
   ...
   *          Rechtecks
   * @param breite
   *          Breite des Rechtecks (in Richtung x-Achse)
   * @param hoehe
   *          H&ouml;he des Rechtecks (in Richtung y-Achse)
   */
   ...
   * 
   * @param x
   *          x-Koordinate des Mittelpunkt des Kreises
   * @param y
   *          y-Koordinate des Mittelpunkt des Kreises
   * @param radius
   *          Radius des Kreises
   */
   ...
   * 
   * @param x1
   *          x-Koordinate des ersten Punkts der Linie
   * @param y1
   *          y-Koordinate des ersten Punkts der Linie
   * @param x2
   *          x-Koordinate des zweiten Punkts der Linie
   * @param y2
   ...
   * 
   * @param x
   *          x-Koordinate des Startpunkts des Textes
   * @param y
   ...
   *          this &uuml;bergeben).
   * @param name
   *          Name des Objekts, der zus&auml;tzlich mit an
   ...
   *          eindeutig identifizieren.
   * @param x
   *          neue x-Koordniate des graphischen Elements
   * @param y
   ...
   * 
   * @param o
   *          Objekt, dass informiert werden m&ouml;chte,
